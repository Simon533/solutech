    ...
    <div v-if="currentTask" class="edit-form">
        ...
        <form method="store">
            ...
            <div class="form-group">
                ...
                {{ currentTask.completed ? "Completed" : "Non completed" }}
            </div>
        </form>

        <button class="badge badge-primary mr-2" v-if="currentTask.published" @click="updatePublished(false)">
            UnPublish
        </button>
